    ...
    public partial class EditSupplyEntryDialog : Window
    {
        ...
        private void PopulateFields()
        {
            ...
            try
            {
                ...
                FarmWeightTextBox.Text = _supplyEntry.FarmWeight?.ToString(System.Globalization.CultureInfo.InvariantCulture) ?? "";
                FarmDiscountTextBox.Text = _supplyEntry.FarmDiscountRate?.ToString(System.Globalization.CultureInfo.InvariantCulture) ?? "";
                FarmPriceTextBox.Text = _supplyEntry.FarmPricePerKilo?.ToString(System.Globalization.CultureInfo.InvariantCulture) ?? "";
                ...
                FactoryWeightTextBox.Text = _supplyEntry.FactoryWeight?.ToString(System.Globalization.CultureInfo.InvariantCulture) ?? "";
                FactoryDiscountTextBox.Text = _supplyEntry.FactoryDiscountRate?.ToString(System.Globalization.CultureInfo.InvariantCulture) ?? "";
                FactoryPriceTextBox.Text = _supplyEntry.FactoryPricePerKilo?.ToString(System.Globalization.CultureInfo.InvariantCulture) ?? "";

                // Transport and notes
                FreightCostTextBox.Text = _supplyEntry.FreightCost?.ToString(System.Globalization.CultureInfo.InvariantCulture) ?? "";
